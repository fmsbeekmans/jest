  ...
  {:tutorial
   [(fn level1 []
    ...
    (fn level3 []
      ...
      (jest.world.building/enable-spawner (build-spawn (jest.world/cell [4 4]) :truck) 0 4000)
      (jest.world.building/enable-spawner (build-spawn (jest.world/cell [4 12]) :truck) 1000 4000)
      (jest.world.building/enable-spawner (build-spawn (jest.world/cell [10 6]) :truck) 3000 4000)
      (jest.world.building/enable-spawner (build-spawn (jest.world/cell [11 7]) :truck) 2000 4000)
      (build-spawn (jest.world/cell [12 9]) :truck)
      (build-supply (jest.world/cell [8 11]) :green)
...
(defn filled-depots? []
  (every? #(>= %1 1.0) (map (comp first building-resource-rate) (all-depots))))
