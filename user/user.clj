  ...
  {:tutorial
   [(fn level1 []
    ...
    (fn level3 []
      ...
      (build-supply (jest.world/cell [7 7]) :red)
      (build-supply (jest.world/cell [7 9]) :blue)
      (build-depot (jest.world/cell [13 8]) :red 10)
      (build-depot (jest.world/cell [14 8]) :blue 10)
