(ns jest.movement-test
  ...
  (:require [jest.world :as w :refer [cell]]
            ...
            [jest.behavior.movement :as m]
            [jest.behavior.spawn :as s]))
...
(spawn-fact
 ...
 (let [vehicle (s/spawn (w/cell [5 5]))]
...
(spawn-fact
 ...
 (:state (s/spawn (w/cell [5 5]))) => :spawning)
